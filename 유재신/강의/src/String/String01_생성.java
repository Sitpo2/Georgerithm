...
public class String01_생성 {
	...
	public static void main(String[] args) {
		// 1. 리터럴 사용 -> String Pool에 저장
		String str1 = "Hello";
		String str2 = "Hello"; //두개의 변수는 하나의 "Hello"를 가리키고 있다.
		
		System.out.println(str1==str2); //객체어서 == 비교연산지는 주소비교
		...
		//2. 힙에 직접 생성
		 ...
		 //문자열을 비교할 때는 equls를 써라!!
		 
		 //3. byte 배열 이용 (쓸일 없을 듯 ㅋㅋ)
		 ...
		 //문자열은 불변성!! -> 중간 문자를 바꾸고 싶다! -> 문자의 배열을 바꾸고 -> 값을 갱신 -> 다시 문자열로
